...
function mainHeader() {
  return (
    <div className="flex bg-blue-900 justify-around text-gray-300 h-20 border-b border-gray-500">
      <div className="flex text-white gap-2 items-center">
        <img className="w-10" src={Logo} alt="Logo" />
        <h2 className="text-2xl font-semibold w-50">Ai Resume</h2>
      </div>
      <div className="list-none flex gap-7 items-center  font-semibold ">
